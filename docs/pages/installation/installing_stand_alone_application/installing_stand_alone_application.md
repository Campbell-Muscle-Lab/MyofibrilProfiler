...
+ The installer file can be downloaded from the [GitHub page](https://github.com/Campbell-Muscle-Lab/MyoProfiler/tree/main/bin/22May26). 22May26 installer is the current MyoProfiler build. In this case, the installer file is located under your designated Downloads folder.
+ Users can also clone the MyoProfiler repository and access the zipped installer file. The installer file is located under `<repo>bin\22May26`. The instructions on how to clone a repository can be found [here](../cloning_myofibrilprofiler/cloning_myofibril_profiler.html).
